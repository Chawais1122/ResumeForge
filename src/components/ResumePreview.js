        ...
        <div ref={printElem}>
          ...
          >
            <HStack spacing={1}>
              <MdMail />{' '}
              <Text>
                {about.email ? about.email : 'chaudharyawais.pk@gmail.com'}
              </Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocalPhone />{' '}
              <Text>{about.phone ? about.phone : '+923340747390'}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocationPin />{' '}
              <Text>{about.address ? about.address : 'Lahore, PK'}</Text>
            </HStack>
            <HStack spacing={1}>
              <RiLinkedinBoxFill />{' '}
                  ...
                  return (
                    ...
                    >
                      <Text fontWeight={'medium'}>
                        {degree ? degree : 'Bachelor In Computer Science'}
                      </Text>
                      <Text fontSize={'sm'}>
                        {school ? school : 'Bahria University'}
                      </Text>
                      <HStack
                        fontSize={'xs'}
                        fontStyle={'italic'}
                      ...
                      >
                        <Text>
                          {startYr ? startYr : 2016} - {endYr ? endYr : 2020}
                        </Text>
                        <Text>{grade ? grade : '3.3 CGPA'}</Text>
                      </HStack>
                    </VStack>
                  );
                })}
